      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600">
            Keep experimentation, evaluation, deployment, and monitoring in one focused workflow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 lg:p-10 shadow-sm">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-3 leading-relaxed">{current.description}</p>
            </div>
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 sm:p-5 space-y-4 shadow-sm">
                <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                  <div className="flex items-center gap-2 text-xs font-mono">
                    ...
                    <span className="text-slate-900 font-bold">Workflow Node Composer</span>
                  </div>
                ...
                <div className="space-y-3 font-mono text-xs">
                  ...
                  <div className="p-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between shadow-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-800 font-medium">Model: flow-core-v2</span>
                    </div>
                ...
                <div className="space-y-2.5 font-mono text-xs">
                  <div className="p-3 rounded-lg bg-white border border-slate-200 space-y-2 shadow-xs">
                    <div className="flex items-center justify-between">
                      <span className="text-slate-900 font-bold">TC-108: Multi-turn ambiguity handling</span>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[11px]">
                      <div className="p-2 rounded bg-slate-100 border border-slate-200">
                        <span className="text-slate-500 block text-[10px]">v2.3 Output Score: 0.81</span>
                        <span className="text-amber-700 text-[10px] font-medium">Missing clarifying prompt</span>
                      </div>
                      <div className="p-2 rounded bg-slate-100 border border-slate-200">
                        <span className="text-slate-500 block text-[10px]">v2.4 Output Score: 0.98</span>
                  ...
                  <div className="p-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between shadow-xs">
                    <div>
                      <span className="text-slate-900 font-bold block">TC-109: Schema validation strictness</span>
            ...
            {activeTab === "monitor" && (
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 sm:p-5 space-y-4 shadow-sm">
                ...
                <div className="space-y-2 font-mono text-xs">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-[11px] text-slate-600 font-medium">
                      <span>2. Model Inference (flow-core-v2)</span>
