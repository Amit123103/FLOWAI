...
import { Code2, CheckCircle2, Shield, Sparkles } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
              Keep your workflow definition, evaluation context, and deployment configuration close to the work with TypeScript & Python SDKs.
            </p>
