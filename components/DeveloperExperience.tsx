    ...
    <section id="developer" className="py-20 md:py-32 relative" aria-labelledby="dev-heading">
      <div className="max-w-global mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3">
                <div className="p-1.5 rounded-lg bg-brand-500/10 border border-brand-500/20 text-brand-300 shrink-0 mt-0.5">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-foreground">Declarative workflow configs</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-foreground">Integrated evaluation suites</h4>
                  <p className="text-xs text-muted mt-0.5">
          ...
          {/* Right Column: Code Editor Mockup (Section 34) */}
