    ...
    <section className="relative pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-brand-50 border border-brand-200 text-xs font-mono tracking-wider uppercase text-brand-700 shadow-sm">
          ...
          <div className="pt-1 flex items-center justify-center gap-2 text-xs text-slate-500 font-mono">
